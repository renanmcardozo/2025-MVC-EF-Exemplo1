        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EditoraCidade = table.Column<string>(type: "TEXT", maxLength: 60, nullable: true),
                    EditoraUF = table.Column<string>(type: "TEXT", maxLength: 2, nullable: true),
                    EditoraPais = table.Column<string>(type: "TEXT", maxLength: 40, nullable: true),
